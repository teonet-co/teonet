...
${OBJECTDIR}/src/config/conf.o: src/config/conf.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config/conf.o src/config/conf.c

${OBJECTDIR}/src/config/opt.o: src/config/opt.c 
	${MKDIR} -p ${OBJECTDIR}/src/config
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config/opt.o src/config/opt.c

${OBJECTDIR}/src/ev_mgr.o: src/ev_mgr.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ev_mgr.o src/ev_mgr.c

${OBJECTDIR}/src/hotkeys.o: src/hotkeys.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hotkeys.o src/hotkeys.c

${OBJECTDIR}/src/modules.o: src/modules.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/modules.o src/modules.c

${OBJECTDIR}/src/modules/vpn.o: src/modules/vpn.c 
	${MKDIR} -p ${OBJECTDIR}/src/modules
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/modules/vpn.o src/modules/vpn.c

${OBJECTDIR}/src/net_arp.o: src/net_arp.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_arp.o src/net_arp.c

${OBJECTDIR}/src/net_com.o: src/net_com.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_com.o src/net_com.c

${OBJECTDIR}/src/net_core.o: src/net_core.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_core.o src/net_core.c
...
${OBJECTDIR}/src/utils/string_arr.o: src/utils/string_arr.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utils/string_arr.o src/utils/string_arr.c

${OBJECTDIR}/src/utils/utils.o: src/utils/utils.c 
	${MKDIR} -p ${OBJECTDIR}/src/utils
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utils/utils.o src/utils/utils.c
...
${OBJECTDIR}/src/config/conf_nomain.o: ${OBJECTDIR}/src/config/conf.o src/config/conf.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config/conf_nomain.o src/config/conf.c;\
	else  \
...
${OBJECTDIR}/src/config/opt_nomain.o: ${OBJECTDIR}/src/config/opt.o src/config/opt.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config/opt_nomain.o src/config/opt.c;\
	else  \
...
${OBJECTDIR}/src/ev_mgr_nomain.o: ${OBJECTDIR}/src/ev_mgr.o src/ev_mgr.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ev_mgr_nomain.o src/ev_mgr.c;\
	else  \
...
${OBJECTDIR}/src/hotkeys_nomain.o: ${OBJECTDIR}/src/hotkeys.o src/hotkeys.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hotkeys_nomain.o src/hotkeys.c;\
	else  \
...
${OBJECTDIR}/src/modules_nomain.o: ${OBJECTDIR}/src/modules.o src/modules.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/modules_nomain.o src/modules.c;\
	else  \
...
${OBJECTDIR}/src/modules/vpn_nomain.o: ${OBJECTDIR}/src/modules/vpn.o src/modules/vpn.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/modules/vpn_nomain.o src/modules/vpn.c;\
	else  \
...
${OBJECTDIR}/src/net_arp_nomain.o: ${OBJECTDIR}/src/net_arp.o src/net_arp.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_arp_nomain.o src/net_arp.c;\
	else  \
...
${OBJECTDIR}/src/net_com_nomain.o: ${OBJECTDIR}/src/net_com.o src/net_com.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_com_nomain.o src/net_com.c;\
	else  \
...
${OBJECTDIR}/src/net_core_nomain.o: ${OBJECTDIR}/src/net_core.o src/net_core.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/net_core_nomain.o src/net_core.c;\
	else  \
...
${OBJECTDIR}/src/utils/string_arr_nomain.o: ${OBJECTDIR}/src/utils/string_arr.o src/utils/string_arr.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utils/string_arr_nomain.o src/utils/string_arr.c;\
	else  \
...
${OBJECTDIR}/src/utils/utils_nomain.o: ${OBJECTDIR}/src/utils/utils.o src/utils/utils.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/utils/utils_nomain.o src/utils/utils.c;\
	else  \
