...
void test_2_8() {
    ...
    ssize_t recvlen = recvfrom(fd_r, buf_recv, KSN_BUFFER_SIZE, 0, (__SOCKADDR_ARG) &addr_recv, (socklen_t *__restrict)&addr_recv_len);
    ...
    recvlen = recvfrom(fd_r, buf_recv, KSN_BUFFER_SIZE, 0, (__SOCKADDR_ARG) &addr_recv, (socklen_t *__restrict)&addr_recv_len);
