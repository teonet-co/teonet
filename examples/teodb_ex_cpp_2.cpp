...
#define TEODB_PEER eventManager()->teo_cfg.app_argv[1]
...
public:
    ...
    TeoDB *teoDb = NULL;
    teo::Teonet::TeoDB::teoDbData *tdd;

    MyTeonet(int argc, char** argv, void *user_data) : teo::Teonet(argc, argv, NULL,
            READ_OPTIONS|READ_CONFIGURATION|APP_PARAM, 0, user_data) { 
        
        teoDb = new teo::Teonet::TeoDB(this, TEODB_PEER, &tdd);
    }
    virtual ~MyTeonet() { 
        /*std::cout << "Destructor myTeonet\n";*/ 
        if(teoDb) delete(teoDb); 
    }
...
int main(int argc, char** argv) {
    ...
    auto *teo = new MyTeonet(argc, argv, &app_param);
